	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(_gameTimerComponentGameTimerComponent2['default'], { gameTime: this.props.gameTime, isReset: this.props.resetGameTime })
	        ),
	        _react2['default'].createElement(
	          'div',
	...
	var GameTimerComponent = (function (_React$Component) {
	  ...
	  _createClass(GameTimerComponent, [{
	    ...
	    value: function timeFunc() {
	      _actionsGameActions2['default'].updateTime(this.props.gameTime - 1);
