...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: tc1 },
	            _react2['default'].createElement(_questionIndxComponentQuestionIndxComponent2['default'], { currentIndx: this.props.currentIndx })
	          ),
	          _react2['default'].createElement(
	            'div',
	            { className: 'question_answer-question-text question_answer-question-right' },
	            _react2['default'].createElement(_questionComponentQuestionComponent2['default'], null)
	          )
	        ),
	        _react2['default'].createElement(
	          'div',
	          ...
	          _react2['default'].createElement(
	            ...
	            _react2['default'].createElement(_answerComponentAnswerComponent2['default'], null)
	          )
	        )
	      );
	    }
	...
	QuestionAnswerComponent.propTypes = {
	  ...
	  currentIndx: _react2['default'].PropTypes.string.isRequired
	};
	  ...
	  _createClass(QuestionComponent, [{
	    ...
	    value: function render() {
	      return _react2['default'].createElement(
	        'span',
	        null,
	        'Juventus were the comfortable winners of this season’s Serie A, finishing 17 points ahead of which team, currently featuring the players Daniele de Rossi and Gervinho?'
	      );
	    }
	  }]);
