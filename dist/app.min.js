	      ...
	      return _react2['default'].createElement(
	        ...
	        _react2['default'].createElement(
	          ...
	          _react2['default'].createElement(
	            'div',
	            { className: tc1 },
	            _react2['default'].createElement(_questionIndxComponentQuestionIndxComponent2['default'], null)
	          ),
	          _react2['default'].createElement(
	            'div',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var GameStore = (function () {
	  ...
	  _createClass(GameStore, [{
	    key: 'getRound',
	    value: function getRound(questionSet) {
	      var lastQuestion = questionSet.find(function (question) {
	        return !question.get('hasFinished');
	      });

	      if (lastQuestion) {
	        var _lastQuestion$get = lastQuestion.get('indx');

	        var _lastQuestion$get2 = _slicedToArray(_lastQuestion$get, 1);

	        var round = _lastQuestion$get2[0];
	    ...
	    value: function setRound() {
	      var roundName = 'Round ' + this.getRound(this.state.gameData.get('questionSet'));
	      this.setState({
